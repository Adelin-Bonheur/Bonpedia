       ...
       <!-- /w3l-medile-movies-grids -->
            <div class="w3l-medile-movies-grids">
                <!-- /movie-browse-agile -->
                      <div class="movie-browse-agile">
                        ...
                        <div class="browse-agile-w3ls general-w3ls">
                                <div class="tittle-head">
                                    <h4 class="latest-text">PC Games </h4>
                                    <div class="container">
                    ...
                    $start = $page * $per_page;
                    $msg = "";
                    $sql = "SELECT * FROM pc_games ORDER BY g_year DESC LIMIT $start, $per_page";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<div class='col-md-2 w3l-movie-gride-agile'>
                              ...
                              <h6><a href='../games/".$row['g_id']."' title='".$row['g_name']." ".$row['g_year']."'>";
                ?>
...
$query_pag_num = mysqli_query($conn,"SELECT COUNT(*) AS mycount FROM pc_games" ) or die(mysqli_error($this->dblink));
