...
<title>Application & System softares</title>
       ...
       <!-- /w3l-medile-movies-grids -->
            <div class="w3l-medile-movies-grids">
                <!-- /movie-browse-agile -->
                      <div class="movie-browse-agile">
                        ...
                        <div class="browse-agile-w3ls general-w3ls">
                                <div class="tittle-head">
                                    <h4 class="latest-text">Applications & Systems </h4>
                                    <div class="container">
                    ...
                    $start = $page * $per_page;
                    $msg = "";
                    $sql = "SELECT * FROM app_sys ORDER BY `app_sys`.`a_name` ASC LIMIT $start, $per_page";
                    ...
                    echo "<div class='col-md-2 w3l-movie-gride-agile'>
                              <a href='../apps-sys/".$row['a_id']."' class='hvr-shutter-out-horizontal'><img src='images/".$row['a_image']."' title='' class='img-responsive' alt='' /><div class='w3l-action-icon'>".$row['a_size']."</div>
                              </a>
                              <div class='mid-1 agileits_w3layouts_mid_1_home'>
                              <div class='w3l-movie-text' style='height: 30px; text-align: left; margin-left: 3px;'>
                              <h6><a href='../apps-sys/".$row['a_id']."' title='".$row['a_name']." ".$row['a_version']."'>";
                    ?>
...
$query_pag_num = mysqli_query($conn,"SELECT COUNT(*) AS mycount FROM app_sys" ) or die(mysqli_error($this->dblink));
