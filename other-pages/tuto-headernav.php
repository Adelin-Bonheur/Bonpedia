<!-- header -->
	<div class="header">
		<div class="container">
			...
			<div class="w3_search">
				<form action="tuto-search.php" method="POST">
					<input type="text" name="search" autocomplete="on"  placeholder="Tutorial Search..." minlength="7" required="" >
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="../other-pages/tutorials">Tutorials</a></li>
