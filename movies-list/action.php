       ...
       <!-- /w3l-medile-movies-grids -->
            <div class="w3l-medile-movies-grids">
                <!-- /movie-browse-agile -->
                    ...
                    $start = $page * $per_page;
                    $msg = "";
                    $sql = "SELECT * FROM movies WHERE other_genres LIKE '%Action%' ORDER BY m_year DESC LIMIT $start, $per_page";
                    ...
                    echo "<div class='col-md-2 w3l-movie-gride-agile'>
                         ...
                         <h6><a href='single-movie.php?id=".$row['m_id']."' title='".$row['m_name']."'>";
                    ?>
...
<?php
//-------------Part One PHP Codes for a well working pagination--------------
$query_pag_num = mysqli_query($conn,"SELECT COUNT(*) AS mycount FROM movies WHERE other_genres LIKE '%Action%'" ) or die(mysqli_error($this->dblink));
