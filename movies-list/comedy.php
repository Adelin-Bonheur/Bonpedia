       ...
       <!-- /w3l-medile-movies-grids -->
            <div class="w3l-medile-movies-grids">
                <!-- /movie-browse-agile -->
                    ...
                    $start = $page * $per_page;
                    $msg = "";
                    $sql = "SELECT * FROM movies WHERE other_genres LIKE '%Comedy%' ORDER BY m_year DESC LIMIT $start, $per_page";
...
$query_pag_num = mysqli_query($conn,"SELECT COUNT(*) AS mycount FROM movies WHERE other_genres LIKE '%Comedy%'" ) or die(mysqli_error($this->dblink));
