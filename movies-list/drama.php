       ...
       <!-- /w3l-medile-movies-grids -->
            <div class="w3l-medile-movies-grids">
                <!-- /movie-browse-agile -->
                      <div class="movie-browse-agile">
                        ...
                        <div class="browse-agile-w3ls general-w3ls">
                                <div class="tittle-head">
                                    <h4 class="latest-text">Drama Movies </h4>
                                    <div class="container">
                    ...
                    $start = $page * $per_page;
                    $msg = "";
                    $sql = "SELECT * FROM movies WHERE other_genres LIKE '%Drama%' ORDER BY m_year DESC LIMIT $start, $per_page";
...
$query_pag_num = mysqli_query($conn,"SELECT COUNT(*) AS mycount FROM movies WHERE other_genres LIKE '%Drama%'" ) or die(mysqli_error($this->dblink));
